...
/**
 ...
 @param smallDate 早期时间
 @param bigDate 结束时间
 @param interval 最大间隔时间
 @return 是否超过了最大间隔时间，yes-超过，no反之
 */
+ (BOOL)jl_compareSmallDate:(NSDate *)smallDate bigDste:(NSDate *)bigDate maxInterval:(NSNumber *)interval;
